  ...
  <div>
    ...
    <ContentMenu :contact-link="false">
      ...
      <p>
        ...
        and conditions), and DrinkSight Ltd, the owner and operator of this
        Website. Please read these terms and conditions carefully, as they
        ...
        Website. If you do not agree to be bound by these terms and conditions,
      ...
      <p>
        ...
        DrinkSight Ltd and acting in the course of their employment or (ii)
        engaged as a consultant or otherwise providing services to DrinkSight
      ...
      <ol>
        <li>
          ...
          property of DrinkSight Ltd, our affiliates or other relevant third
      ...
      <ol>
        <li>
          ...
          stated, these sites are not under the control of DrinkSight Ltd or
      ...
      <ol>
        <li>
          ...
          reference. To view the Privacy Policy and Cookies Policy, please visit
          <nuxt-link to="/privacy">https://drinksight.com/privacy</nuxt-link>
        </li>
      </ol>
      ...
      <ol>
        <li>
          Any online facilities, tools, services or information that DrinkSight
          Ltd makes available through the Website (the <b>Service</b>) is
          ...
          extent permitted by the law, we provide no warranties (express or
          implied) of fitness for a particular purpose, accuracy of information,
          compatibility and satisfactory quality. DrinkSight Ltd is under no
          obligation to update information on the Website.
        </li>

        <li>
          Whilst DrinkSight Ltd uses reasonable endeavours to ensure that the
        ...
        <li>
          DrinkSight Ltd accepts no liability for any disruption or
          non-availability of the Website.
        </li>

        <li>
          DrinkSight Ltd reserves the right to alter, suspend or discontinue any
      ...
      <ol>
        ...
        <li>
          To the maximum extent permitted by law, DrinkSight Ltd accepts no
      ...
      <h2>
        DrinkSight Ltd details
      </h2>
      <ol>
        <li>
          DrinkSight Ltd is a company incorporated in England and Wales with
          registered number 11930916 whose registered address is 20-22 Wenlock
          Road, London, N1 7GU and it operates the Website drinksight.com.

          <p>
            You can contact DrinkSight Ltd by email on
            <a href="mailto:support@drinksight.com">support@drinksight.com</a>.
          </p>
        </li>
      </ol>
...
<script>
const desc =
  'These terms and conditions apply between you, the User of this Website (including any sub-domains, unless expressly excluded by their own terms and conditions), and DrinkSight Ltd'
const title = 'Terms of Use: DrinkSight'
